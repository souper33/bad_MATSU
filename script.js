(() => {
  ...
  function safePlay() {
    // If the track already reached the end, the cursor stays parked on the
    // last frame — restart it from zero so it both replays and re-counts.
  ...
  audio.addEventListener("ended", () => {
    ...
    curTimeEl.textContent = formatClock(0);
    persistStats();
  });
